...
var appRoutes = [
    ...
    { path: 'form-empleado', component: __WEBPACK_IMPORTED_MODULE_14__components_form_empleado_form_empleado_component__["a" /* FormEmpleadoComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_21__guards_auth_guard__["a" /* AuthGuard */]] },
    { path: 'form-vehiculo', component: __WEBPACK_IMPORTED_MODULE_15__components_form_vehiculo_form_vehiculo_component__["a" /* FormVehiculoComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_21__guards_auth_guard__["a" /* AuthGuard */]] },
    { path: 'garage', component: __WEBPACK_IMPORTED_MODULE_16__components_garage_garage_component__["a" /* GarageComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_21__guards_auth_guard__["a" /* AuthGuard */]] },
    { path: 'solicitar-orden', component: __WEBPACK_IMPORTED_MODULE_17__components_solicitar_orden_solicitar_orden_component__["a" /* SolicitarOrdenComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_21__guards_auth_guard__["a" /* AuthGuard */]] }
];
...
var FormVehiculoComponent = /** @class */ (function () {
    function FormVehiculoComponent(apiService, flashMessage, router) {
        this.apiService = apiService;
        this.flashMessage = flashMessage;
        this.router = router;
    }
    ...
    FormVehiculoComponent.prototype.registrarVehiculo = function () {
        ...
        this.apiService.setVehicleData(data).subscribe(function (response) {
            if (response.success) {
                _this.flashMessage.show(response.msg, { cssClass: 'custom-success', timeout: 3000 });
...
var GarageComponent = /** @class */ (function () {
    function GarageComponent(apiService, flashMessage, router) {
        this.apiService = apiService;
        this.flashMessage = flashMessage;
        this.router = router;
    }
    GarageComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.apiService.getVehicles().subscribe(function (data) {
    ...
    GarageComponent.prototype.eliminarVehiculo = function (indice) {
        var _this = this;
        this.apiService.eliminarVehiculo(this.vehiculos[indice].id).subscribe(function (response) {
            if (response.success) {
                _this.flashMessage.show(response.msg, { cssClass: 'custom-success', timeout: 3000 });
            }
            else {
...
var SolicitarOrdenComponent = /** @class */ (function () {
    function SolicitarOrdenComponent(apiService, flashMessage, router) {
        this.apiService = apiService;
        this.flashMessage = flashMessage;
        this.router = router;
    }
    ...
    SolicitarOrdenComponent.prototype.solicitarOrden = function () {
        ...
        if (this.servicio == undefined || this.servicio == '' || this.detalles == undefined || this.detalles == '') {
            ...
            this.apiService.crearOrden(data).subscribe(function (response) {
                if (response.success) {
                    _this.flashMessage.show(response.msg, { cssClass: 'custom-success', timeout: 3000 });
...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.setVehicleData = function (data) {
        ...
        headers.append('Content-Type', 'application/json');
        // Hacer la petición, se retorna una promesa
        return this.http.post('users/registrar-vehiculo', data, { headers: headers })
            .map(function (res) { return res.json(); });
    };
    ...
    ApiService.prototype.eliminarVehiculo = function (id) {
        // Settear los encabezados para la petición al API
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-Type', 'application/json');
        // Hacer la petición, se retorna una promesa
        return this.http.post('users/eliminar-vehiculo', { id: id }, { headers: headers })
            .map(function (res) { return res.json(); });
    };
    ApiService.prototype.crearOrden = function (data) {
        // Settear los encabezados para la petición al API
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-Type', 'application/json');
        // Hacer la petición, se retorna una promesa
